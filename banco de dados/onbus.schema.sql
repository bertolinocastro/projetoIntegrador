...
CREATE TABLE IF NOT EXISTS onbus.ponto (
  ...
  latitude_ponto DECIMAL(16,14) NOT NULL,
  longitude_ponto DECIMAL(16,14) NOT NULL,
...
CREATE TABLE IF NOT EXISTS onbus.estado_onibus (
  ...
  latitude_act DECIMAL(16,14) NOT NULL,
  longitude_act DECIMAL(16,14) NOT NULL,
