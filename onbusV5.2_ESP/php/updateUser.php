<?php
  ...
  $pass = $_SESSION['senha']; 
	$dados = $User->getInfoUser($loger, $pass);
        ...
        <div class="panel-body">
          <form method="POST" action="update.php" role="form">
            ...
            <div class="form-group">
              ...
              <input id="signupEmail" type="text" name="senha" disabled maxlength="50" required="True"class="form-control" value="<?php 
            ...
            <div class="form-group">
              ...
              <input id="signupEmail" type="text" name="senha" maxlength="50" disabled required="True"class="form-control" value="<?php 
              foreach ($dados as $reg){ echo $reg->email;  } ?>">
            </div>
            <div class="form-group">
              <label class="control-label" for="signupEmail">Nascimento</label>
              <input id="signupEmail" type="date" name="senha" maxlength="50" disabled required="True"class="form-control" value="<?php 
